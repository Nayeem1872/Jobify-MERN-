...
//     try {
//         const response = await axios.post('http://127.0.0.1:5000/api/v1/auth/register',currentUser)
...
//     dispatch({ type: LOGIN_USER_BEGIN })
//     try {
//       const { data } = await axios.post(`http://127.0.0.1:5000/api/v1/auth/login`, currentUser)
